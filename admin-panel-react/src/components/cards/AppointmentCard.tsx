...
export function AppointmentCard({ clientName, clientId, time, status, appointment }: AppointmentCardProps) {
  ...
  return (
    <div className="p-4 border rounded-lg hover:shadow-md transition-all cursor-pointer group bg-white border-gray-200">
                  ...
                  <div className="grid grid-cols-1 gap-1.5 text-xs">
                    ...
                    {(customerInfo.chatId || clientId) && (
                      <div className="flex items-center gap-1.5">
                        ...
                        <span className="text-gray-900">{customerInfo.chatId || clientId}</span>
                      </div>
                    )}
                  </div>
                </div>
