...
export function QuickActionCard({ 
  ...
  return (
    <Card 
      className="p-4 bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800 hover:shadow-md dark:hover:shadow-lg hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-all cursor-pointer group"
      onClick={onClick}
    >
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center justify-between gap-2 mb-1">
            ...
            {badge && (
              <Badge 
                className={`
                  text-[11px] px-2 py-0.5 h-5 whitespace-nowrap flex-shrink-0
