...
export function AIAssistantPage({}: AIAssistantPageProps) {
  ...
  const [instructions, setInstructions] = useState(
    "Тебе зовут Давид ты должен быть весёлый дружелюбный и добрый и тебе 120 лет если спросят также всегда говорю что ты"
  );
  ...
  const handleTest = () => {
    ...
    toast.info("Testing AI Assistant...", {
      description: "Sending test message to AI",
    });
  };
