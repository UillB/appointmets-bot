    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 relative z-10">
        ...
        <div className="hidden lg:flex flex-col justify-center space-y-8">
          ...
          {/* Social Proof */}
          <div className="p-6 bg-white/60 backdrop-blur-sm rounded-2xl border border-white/60 shadow-lg">
            <div className="flex items-center gap-3 mb-3">
              <div className="flex -space-x-2">
                ...
                <div className="w-10 h-10 bg-gradient-to-br from-pink-400 to-pink-500 rounded-full border-2 border-white"></div>
              </div>
              <div>
                <div className="text-sm text-gray-900">
                  Join 10,000+ users
                </div>
                <div className="text-xs text-gray-500">Already managing appointments</div>
              </div>
            </div>
