...
export function AppointmentsSummaryCard({ 
  ...
  return (
    <Card className="p-6 bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-indigo-950 dark:via-purple-950 dark:to-pink-950 border-indigo-200 dark:border-indigo-900">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <div className="flex items-center gap-2">
              ...
              <Badge 
                ...
                className={botActive ? "bg-emerald-600 dark:bg-emerald-500" : "bg-gray-400 dark:bg-gray-600"}
              >
            ...
            <div className="flex items-center gap-2">
              ...
              <Badge 
                ...
                className={adminLinked ? "bg-indigo-600 dark:bg-indigo-500" : "bg-amber-500 dark:bg-amber-600"}
              >
