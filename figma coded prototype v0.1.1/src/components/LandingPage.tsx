...
export function LandingPage({ onGetStarted, onLogin, onViewPricing, onViewContact }: LandingPageProps) {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-14 lg:h-16">
            <div className="flex items-center gap-2 lg:gap-3 min-w-0 flex-1">
              ...
              <span className="text-lg lg:text-2xl bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent truncate">
                AppointBot
              </span>
            </div>
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              ...
              <Button 
                variant="ghost" 
                size="icon" 
                className="hover:bg-gray-100 dark:hover:bg-gray-800 h-8 w-8 lg:h-9 lg:w-9"
              ...
              <Button 
                variant="ghost" 
                onClick={onLogin}
                className="hidden lg:flex hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-700 dark:text-gray-300 h-9"
              >
                Sign In
              </Button>
              <Button 
                onClick={onGetStarted}
                className="bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 shadow-lg text-white h-8 lg:h-10 text-xs lg:text-sm px-3 lg:px-4"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 xl:gap-16 items-center">
            ...
            <div className="space-y-4 lg:space-y-6 xl:space-y-8 text-center lg:text-left">
              <Badge className="bg-indigo-100 dark:bg-indigo-900/50 text-indigo-700 dark:text-indigo-300 hover:bg-indigo-100 dark:hover:bg-indigo-900/50 border-0 inline-flex text-xs lg:text-sm">
                <Sparkles className="w-3 h-3 mr-1" />
                Powered by AI & Telegram
              </Badge>

              <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl text-gray-900 dark:text-gray-100">
                Online Booking
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3 lg:gap-4">
                <Button 
                  size="lg"
                  onClick={onGetStarted}
                  className="bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 h-11 lg:h-12 xl:h-14 px-6 lg:px-8 text-sm lg:text-base xl:text-lg shadow-xl text-white w-full sm:w-auto"
                >
                ...
                <Button 
                  ...
                  className="h-11 lg:h-12 xl:h-14 px-6 lg:px-8 text-sm lg:text-base xl:text-lg border-2 border-indigo-600 dark:border-indigo-500 text-indigo-600 dark:text-indigo-400 hover:bg-indigo-50 dark:hover:bg-indigo-950 hover:border-indigo-700 dark:hover:border-indigo-400 w-full sm:w-auto"
                >
          ...
          <div className="mt-12 lg:mt-16 xl:mt-20 grid grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-6 xl:gap-8">
            {stats.map((stat, index) => (
              ...
              >
                ...
                <div className="text-2xl lg:text-3xl xl:text-4xl bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent mb-1">
                  {stat.value}
                </div>
      ...
      <section id="features" className="py-12 lg:py-20 xl:py-32 bg-gray-50 dark:bg-gray-900 transition-colors">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-3 lg:space-y-4 mb-8 lg:mb-12 xl:mb-16">
            <Badge className="bg-indigo-100 dark:bg-indigo-900/50 text-indigo-700 dark:text-indigo-300 hover:bg-indigo-100 dark:hover:bg-indigo-900/50 border-0 text-xs lg:text-sm">
              Features
            </Badge>
            <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl text-gray-900 dark:text-gray-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6 xl:gap-8">
            {features.map((feature, index) => (
              <Card 
                key={feature.title}
                className="p-4 lg:p-6 xl:p-8 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950 relative overflow-hidden group cursor-pointer"
              ...
              >
                ...
                <h3 className="text-lg lg:text-xl xl:text-2xl mb-2 lg:mb-3 text-gray-900 dark:text-gray-100">{feature.title}</h3>
      ...
      <section id="benefits" className="py-12 lg:py-20 xl:py-32 bg-white dark:bg-gray-950 transition-colors">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-3 lg:space-y-4 mb-8 lg:mb-12 xl:mb-16">
            <Badge className="bg-purple-100 dark:bg-purple-900/50 text-purple-700 dark:text-purple-300 hover:bg-purple-100 dark:hover:bg-purple-900/50 border-0 text-xs lg:text-sm">
              Benefits
            </Badge>
            <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl text-gray-900 dark:text-gray-100">
              Why choose
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6 xl:gap-8 max-w-5xl mx-auto">
            {benefits.map((benefit, index) => (
              ...
              >
                ...
                <div>
                  <h3 className="text-base lg:text-lg xl:text-xl mb-1 lg:mb-2 text-gray-900 dark:text-gray-100">{benefit.title}</h3>
      ...
      <section className="py-12 lg:py-20 xl:py-32 bg-gray-50 dark:bg-gray-900 transition-colors">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-3 lg:space-y-4 mb-8 lg:mb-12 xl:mb-16">
            <Badge className="bg-emerald-100 dark:bg-emerald-900/50 text-emerald-700 dark:text-emerald-300 hover:bg-emerald-100 dark:hover:bg-emerald-900/50 border-0 text-xs lg:text-sm">
              How It Works
            </Badge>
            <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl text-gray-900 dark:text-gray-100">
              Get started in
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 xl:gap-12 max-w-6xl mx-auto">
            {[
              ...
              <div key={item.step} className="relative text-center group">
                <div className="inline-flex items-center justify-center w-16 h-16 lg:w-18 lg:h-18 xl:w-20 xl:h-20 bg-gradient-to-br {item.color} rounded-full text-white text-2xl lg:text-3xl mb-4 lg:mb-5 xl:mb-6 shadow-2xl group-hover:scale-110 transition-all duration-300">
                  {item.step}
                </div>
                {index < 2 && (
                  <div className="hidden md:block absolute top-8 lg:top-9 xl:top-10 left-[60%] w-[80%] h-0.5 bg-gradient-to-r from-indigo-200 to-purple-200 dark:from-indigo-800 dark:to-purple-800" />
                )}
                ...
                <h3 className="text-lg lg:text-xl xl:text-2xl mb-2 lg:mb-3 text-gray-900 dark:text-gray-100">{item.title}</h3>
      ...
      <section className="py-12 lg:py-20 xl:py-32 bg-white dark:bg-gray-950 transition-colors">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-3 lg:space-y-4 mb-8 lg:mb-12 xl:mb-16">
            <Badge className="bg-amber-100 dark:bg-amber-900/50 text-amber-700 dark:text-amber-300 hover:bg-amber-100 dark:hover:bg-amber-900/50 border-0 text-xs lg:text-sm">
              Testimonials
            </Badge>
            <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl text-gray-900 dark:text-gray-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-6 xl:gap-8">
            {testimonials.map((testimonial) => (
              <Card key={testimonial.name} className="p-4 lg:p-6 xl:p-8 border-gray-200 dark:border-gray-800 bg-gradient-to-br from-white to-gray-50 dark:from-gray-900 dark:to-gray-950 hover:shadow-xl transition-all duration-300">
                ...
                <div className="flex items-center gap-3 lg:gap-4">
                  <div className="w-10 h-10 lg:w-12 lg:h-12 bg-gradient-to-br from-indigo-500 to-purple-500 rounded-full flex items-center justify-center text-white text-sm lg:text-base shadow-lg flex-shrink-0">
                    {testimonial.avatar}
                  </div>
                  <div>
      ...
      <section className="py-12 lg:py-20 xl:py-32 bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl text-white mb-4 lg:mb-6">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 lg:gap-4">
            <Button 
              size="lg"
              onClick={onGetStarted}
              className="bg-white text-indigo-600 hover:bg-gray-50 h-11 lg:h-12 xl:h-14 px-6 lg:px-8 xl:px-10 text-sm lg:text-base xl:text-lg shadow-2xl w-full sm:w-auto"
            >
            ...
            <Button 
              ...
              className="border-2 border-white text-white bg-transparent hover:bg-white/10 h-11 lg:h-12 xl:h-14 px-6 lg:px-8 xl:px-10 text-sm lg:text-base xl:text-lg w-full sm:w-auto"
            >
              Contact Us
            </Button>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 lg:gap-8 xl:gap-12 mb-6 lg:mb-8 xl:mb-12">
            <div className="col-span-2 md:col-span-1">
              <div className="flex items-center gap-2 lg:gap-3 mb-4 lg:mb-6">
                ...
                <span className="text-lg lg:text-xl xl:text-2xl text-white">AppointBot</span>
              </div>
            ...
            <div>
              <h3 className="text-white mb-3 lg:mb-4 text-sm lg:text-base xl:text-lg">Product</h3>
            ...
            <div>
              <h3 className="text-white mb-3 lg:mb-4 text-sm lg:text-base xl:text-lg">Company</h3>
              <ul className="space-y-2 lg:space-y-3 text-xs lg:text-sm">
            ...
            <div>
              <h3 className="text-white mb-3 lg:mb-4 text-sm lg:text-base xl:text-lg">Connect</h3>
