            ...
            <div className="text-center max-w-2xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                <button
                  ...
                  className="p-4 bg-indigo-50 dark:bg-indigo-950/50 rounded-lg hover:bg-indigo-100 dark:hover:bg-indigo-950/70 transition-colors cursor-pointer border-2 border-transparent hover:border-indigo-200 dark:hover:border-indigo-800 text-center"
                >
                  <div className="w-8 h-8 bg-indigo-600 text-white rounded-full flex items-center justify-center mx-auto mb-2">
                    1
                  </div>
                  <p className="text-sm font-medium text-gray-900 dark:text-gray-100 mb-1">Create Bot</p>
                  <p className="text-xs text-gray-600 dark:text-gray-300">Use @BotFather</p>
                </button>

                <button
                  onClick={handleCreateBot}
                  className="p-4 bg-purple-50 dark:bg-purple-950/50 rounded-lg hover:bg-purple-100 dark:hover:bg-purple-950/70 transition-colors cursor-pointer border-2 border-transparent hover:border-purple-200 dark:hover:border-purple-800 text-center"
                >
                  <div className="w-8 h-8 bg-purple-600 text-white rounded-full flex items-center justify-center mx-auto mb-2">
                    2
                  </div>
                  <p className="text-sm font-medium text-gray-900 dark:text-gray-100 mb-1">Add Token</p>
                  <p className="text-xs text-gray-600 dark:text-gray-300">Configure bot</p>
                </button>

                <button
                  onClick={handleCreateBot}
                  className="p-4 bg-pink-50 dark:bg-pink-950/50 rounded-lg hover:bg-pink-100 dark:hover:bg-pink-950/70 transition-colors cursor-pointer border-2 border-transparent hover:border-pink-200 dark:hover:border-pink-800 text-center"
                >
                  <div className="w-8 h-8 bg-pink-600 text-white rounded-full flex items-center justify-center mx-auto mb-2">
                    3
                  </div>
                  <p className="text-sm font-medium text-gray-900 dark:text-gray-100 mb-1">Link Admin</p>
                  <p className="text-xs text-gray-600 dark:text-gray-300">Authorize access</p>
                </button>
              </div>
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-4 lg:space-y-6">
        ...
        actions={
          <div className="flex gap-2">
            <Button
              ...
              className="h-8 text-xs lg:text-sm px-2 lg:px-3 hidden lg:flex"
            >
              Reset
            </Button>
            <Button
              ...
              className="h-8 text-xs lg:text-sm px-2 lg:px-3"
            >
              <span className="hidden lg:inline">Toggle Admin: {adminLinked ? "Linked" : "Not Linked"}</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 lg:gap-4">
        <Card className="p-3 lg:p-5 bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800">
