...
**File:** `/hooks/useTelegramWebApp.ts`
...
export function Dashboard() {
  const { isTelegramWebApp, colorScheme, user } = useTelegramWebApp();
...
```tsx
<Card className="p-2.5 active:bg-gray-50 dark:active:bg-gray-800 transition-colors">
...
**Last Updated:** November 5, 2025  
**Status:** ✅ Telegram Web App Optimized  
